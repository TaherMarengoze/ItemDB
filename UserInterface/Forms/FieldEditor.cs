...
{
    public partial class FieldEditor<TEntity>: Form
        where TEntity : Interfaces.Models.IFieldList, new()
    {
        #region Constants
        enum ActionColumn
        {
        ...
        #region Fields
        private readonly ListController<TEntity> uiControl;
        ...
        public FieldEditor()
        {
            ...
            ConfigureComponent();
            InitializeFields();
            uiControl = new ListController<TEntity>();
